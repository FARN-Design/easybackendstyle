...
getValueFromDB("highlight")[0][0] = '#2271b1'; //default 2271b1
getValueFromDB("notification")[0][0] = '#d63638'; //default d63638
$GLOBALS['background']= '#f0f0f1'; //default f0f0f1
getValueFromDB("links")[0][0] = '#2271b1'; //default 2271b1
getValueFromDB("buttons")[0][0] = '#2271b1'; //default 2271b1
getValueFromDB("formInputs")[0][0] = '#3582c4'; //default 3582c4
*/
