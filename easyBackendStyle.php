...
class easyBackendStyle {
    ...
    function __construct()
    {
        ...
        $GLOBALS['ebsColorMapping'] = [
            ...
            "ebsLinksHover" => ["linksHover",["rgb(0, 149.5, 221)"],'#0095dd', "Sets the links hover color of the page"],
            ...
            "ebsPrimaryDarker10" => ["primary darker 10",["var(--wp-admin-theme-color-darker-10)"],'#07526c', "Sets the button color when hovering over it"],
            "ebsPrimaryDarker20" => ["primary darker 20",["var(--wp-admin-theme-color-darker-20)"],'#064054', "Sets the button color when clicking it"],
            "ebsSecondaryLighter" => ["secondary lighter", ["rgb(116.162375, 182.0949364754, 205.537625)", "rgb(109.571875, 185.228125, 212.128125)"],'#74a6b9', "Sets the...muss ich mir noch überlegen "],
